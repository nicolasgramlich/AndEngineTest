 ...
 */
public class PriorityAggregatorQueueTest extends AndroidTestCase {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	private static final int PRIORITY_HIGH = PriorityAggregatorQueueTest.PRIORITY_HIGHEST + 1;
	private static final int PRIORITY_MEDIUM = PriorityAggregatorQueueTest.PRIORITY_HIGH + 1;
	private static final int PRIORITY_LOW = PriorityAggregatorQueueTest.PRIORITY_MEDIUM + 1;
	private static final int PRIORITY_LOWEST = PriorityAggregatorQueueTest.PRIORITY_LOW + 1;

	// ===========================================================
	// Fields
	// ===========================================================

	private PriorityAggregatorQueue<String> mPriorityAggregatorQueue;
	...
	protected void setUp() throws Exception {
		this.mPriorityAggregatorQueue = new PriorityAggregatorQueue<String>(true);
	}
	...
	public void testPut() throws InterruptedException {
		this.mPriorityAggregatorQueue.addQueue(PriorityAggregatorQueueTest.PRIORITY_HIGHEST, CAPACITY_ONE);

		this.mPriorityAggregatorQueue.put(PriorityAggregatorQueueTest.PRIORITY_HIGHEST, "A");

		Assert.assertEquals(1, this.mPriorityAggregatorQueue.size());
	}

	public void testPutIsBlocking() throws InterruptedException {
		final PriorityAggregatorQueue<String> paq = PriorityAggregatorQueueTest.this.mPriorityAggregatorQueue;
		this.mPriorityAggregatorQueue.addQueue(PriorityAggregatorQueueTest.PRIORITY_HIGHEST, CAPACITY_ONE);
		...
		new Thread(new FallibleRunnable() {
			...
			public void runFallible() throws InterruptedException {
				...
				paq.put(PriorityAggregatorQueueTest.PRIORITY_HIGHEST, "A");

				paq.put(PriorityAggregatorQueueTest.PRIORITY_HIGHEST, "B");
	...
	public void testOffer() throws InterruptedException {
		...
		final boolean success = this.mPriorityAggregatorQueue.offer(PriorityAggregatorQueueTest.PRIORITY_HIGHEST, "A");
	...
	public void testOfferOnFull() throws InterruptedException {
		...
		this.mPriorityAggregatorQueue.offer(PriorityAggregatorQueueTest.PRIORITY_HIGHEST, "A");
		final boolean success = this.mPriorityAggregatorQueue.offer(PriorityAggregatorQueueTest.PRIORITY_HIGHEST, "B");
	...
	public void testPutWithTake() throws InterruptedException {
		final PriorityAggregatorQueue<String> paq = PriorityAggregatorQueueTest.this.mPriorityAggregatorQueue;
		this.mPriorityAggregatorQueue.addQueue(PriorityAggregatorQueueTest.PRIORITY_HIGHEST, CAPACITY_TWO);
